...
class Utility
{
	...
	* @return array
	*/
	static public function Mapping($type_map, $raw_data)
	{
		...
		if ($keys === array_keys($keys))
		{
			...
			{
				$data[] = self::RowMapping($type_map, $row);
			}
		...
		{
			return self::RowMapping($type_map, $row);
		}
	}
	...
	* @return array
	*/
	static public function RowMapping($type_map, $raw_data)
	{
		$data = [];
		...
		$data = array_merge($raw_data, $data);
